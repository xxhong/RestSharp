...
namespace RestSharp.Serializers.Json.SimpleJson {
    ...
    class JsonObject : DynamicObject, IDictionary<string, object?> {
        /// <summary>
        ...
        /// </returns>
        public bool Contains(KeyValuePair<string, object?> item) => _members.TryGetValue(item.Key, out object? value) && value == item.Value;
        ...
        /// </returns>
        public override string? ToString() => RestSharp.SimpleJson.SerializeObject(this);
        ...
        public override bool TryGetMember(GetMemberBinder binder, out object? result) {
            if (_members.TryGetValue(binder.Name, out object? value)) {
                result = value;
                return true;
            }
